                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`bg-gradient-to-r ${plan.color} p-6 sm:p-8 text-white relative overflow-hidden`}
                        >
                          ...
                          <div className="flex items-center gap-4 mb-4 relative z-10">
                            ...
                            <div>
                              <div className="block text-sm font-bold text-white mb-1">
                                {plan.name}
                              </div>
                              {plan.highlighted && (
                                <div className="block text-xs font-semibold text-amber-200">
                                  Most Popular
                                </div>
                              )}
                            </div>
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`shrink-0 w-6 h-6 rounded-full bg-accent/10 flex items-center justify-center transition-transform duration-300 ${
