          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Established in 2017, TONMAG is at the forefront of disruption in
                the real estate industry, shaping new lifestyles with a focus on
                the integration of revolutionary technology into residential and
                commercial real estate using sustainable methods.
              </p>
              <p className="text-lg text-muted-foreground mb-4">
                TONMAG's leadership team is composed of the industry's highly
                experienced leaders with a passion for unswerving excellence. As
                we continue to grow our vision of becoming the leading real
                estate developer in Africa, the guarantee of integrity,
                professionalism and reliability remains equal to the best
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Constantly transforms urban living in Africa, blending
                innovative design with advanced technology, while steadfastly
                prioritising quality, sustainability, and visionary real estate
                solutions.
              </p>
            </div>
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Become the gold-standard in next-generation living across
                Africa. We envision a future where every TONMAG residence
                defines the benchmark for luxury, technology, and
                sustainability, offering homeowners the pinnacle of modern
                living.
              </p>
            </div>
          </div>
