...
export function HouseTypeDetailContent({ houseType }: { houseType: HouseType }) {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-muted flex-col justify-between p-8 relative rounded-r-3xl overflow-hidden">
        <div className="relative h-full rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 to-transparent text-white">
            ...
            <p className="text-5xl font-bold">${houseType.price.toLocaleString()}</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 p-6 sm:p-10 lg:p-12 overflow-y-auto">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-2">{houseType.name}</h1>
        ...
        <div className="flex gap-8 mb-12 text-center">
          <div>
            <p className="text-4xl font-bold text-foreground">{houseType.beds}</p>
            <p className="text-muted-foreground">beds</p>
          </div>
          <div>
            <p className="text-4xl font-bold text-foreground">{houseType.baths}</p>
            <p className="text-muted-foreground">baths</p>
          </div>
          <div>
            <p className="text-4xl font-bold text-foreground">{houseType.sqft.toLocaleString()}</p>
        ...
        <div className="mb-12">
          ...
          {houseType.amenities.length > 6 && (
            <a href="#" className="text-primary text-sm font-medium hover:underline mt-4 block">
        ...
        <div className="border-t border-border pt-8">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-foreground">{houseType.agent.name}</p>
                <p className="text-sm text-muted-foreground">{houseType.agent.company}</p>
